  ...
  return (
    <div className=" relative xl:min-h-full xl:pt-10">
      <div className="relative z-0 m-auto  w-[90%]  p-2 xl:flex xl:flex-col xl:justify-center xl:gap-6">
        <p className="m-auto  rounded  text-center  text-2xl font-semibold uppercase sm:text-3xl lg:mt-5 lg:text-2xl xl:mt-0 xl:text-4xl">
          Welcome! I'm
        </p>
        ...
        <p className="m-auto w-full px-4 text-center font-ibmplexsans font-semibold xs:text-lg sm:w-4/5 sm:text-xl xl:w-[90%] xl:justify-center xl:text-2xl ">
          A{" "}
          <span className="italic text-celticblue lg:drop-shadow-[0_1.2px_1.2px_rgba(0,0,0,0.8)] ">
