  ...
  return (
    <div className=" relative xl:min-h-full">
      <div className="relative z-0 m-auto  w-[90%]  p-2 xl:flex xl:flex-col xl:justify-center xl:gap-6">
        ...
        <p className="m-auto my-3 w-[18ch] rounded-xl  py-4 text-center font-ibmplexsans text-3xl font-semibold uppercase text-black  lg:mb-10 lg:text-5xl xl:mb-0 xl:text-6xl">
          Stephen <span className="text-celticblue">Johnston</span>
        </p>

        <p className="m-auto w-4/5 px-4 text-center font-ibmplexsans font-semibold xl:text-2xl xl:justify-center">
          A{" "}
          <span className="italic text-celticblue drop-shadow-2xl">
