  ...
  return (
    <div className="xl:w-1/2">
      ...
      <motion.div
        ...
        className="m-auto flex w-4/5 flex-wrap justify-center text-xs xxs:grid xxs:grid-cols-3 xxs:place-items-center xxs:gap-0 md:grid-cols-3 md:gap-5 xmd:grid-cols-6 xl:m-auto  xl:flex  xl:w-2/3 xl:items-center xl:justify-center xl:gap-5 xl:ml-auto"
      >
        {project === 1
