...
const Yahtzee = () => {
  return (
    <motion.div
      ...
      id="yahtzee"
    >
      <div className="yahtzee-bg m-auto min-h-[228px] w-2/3 rounded-xl p-2">
        <img src={YahtzeeLogo} alt="Yahtzee Logo" className="m-auto w-4/5" />
        <h1 className="mt-4 text-center font-['Revue'] text-3xl sm:text-[36px] font-bold normal-case text-white drop-shadow-[0_2.2px_1.2px_rgba(0,0,0,8)] sm:pb-5">
          Yahtzee!
        </h1>
      </div>
